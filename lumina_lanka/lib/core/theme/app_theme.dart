...
/// iOS 26-inspired dark theme with glassmorphism support
/// 
/// Color palette:
...
class AppTheme {
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        elevation: 0,
        centerTitle: true,
        titleTextStyle: TextStyle(fontFamily: 'GoogleSansFlex', 
          fontSize: 17,
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          textStyle: TextStyle(fontFamily: 'GoogleSansFlex', 
            fontSize: 16,
            fontWeight: FontWeight.w600,
          ),
        ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: TextStyle(fontFamily: 'GoogleSansFlex', 
  ...
  /// Custom text theme using Inter (similar to SF Pro)
